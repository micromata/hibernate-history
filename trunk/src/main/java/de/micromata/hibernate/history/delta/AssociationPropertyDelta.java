...
public class AssociationPropertyDelta extends PropertyDelta
{
  ...
  public AssociationPropertyDelta(final SessionFactory factory, String propertyName, Class<?> propertyType, Object oldId, Object newId)
      throws HibernateException
  {
    ...
    if (classMetadata != null) {
      this.oldValue = oldId == null ? null : ConvertUtils.convert(classMetadata.getIdentifier(oldId, EntityMode.POJO));
      this.newValue = newId == null ? null : ConvertUtils.convert(classMetadata.getIdentifier(newId, EntityMode.POJO));
    } else {
